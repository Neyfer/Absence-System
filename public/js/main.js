...
if(document.URL.includes("chart_teacher.ejs")){
    ...
    //FOR CELLPHONESSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS


    if(screen.width < 600){
        document.querySelector(".name").textContent = "M.A.S (Control de inasistencias)";
        document.querySelector(".aside").remove();

        let nav_btn = document.querySelector(".p-nav");
